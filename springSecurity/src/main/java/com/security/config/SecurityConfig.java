...
//	}
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/hello").authenticated().antMatchers("/greet").authenticated().and()
				.formLogin().loginPage("/myLogin").loginProcessingUrl("/processLogin").and().httpBasic().and().logout();
	}
}
